...
type Product = { id:number; name:string; category:string; origin:string; price:number; stock:number; sales:number; rating:number; traceCode:string; badge:string; description:string; icon:string; sellerId?:number; storeName?:string };
